...
class PoseEstimation6dofDataset(Dataset):
    """Dataset for pose estimation 6dof."""
...
def get_dataloader(root, split, config):
    ...
    dataset = PoseEstimation6dofDataset(root, split, transform)
    return DataLoader(
        dataset,
